...
export const MENU: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      { id: 'B1', code: 'B1', name: { zh: '牛肉饺（10个）', en: 'Beef dumplings', ms: 'Ladu daging lembu' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 13.0 },
      { id: 'B2', code: 'B2', name: { zh: '鸡肉饺（10个）', en: 'Chicken dumplings', ms: 'Ladu daging ayam' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 13.0 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'C2', code: 'C2', name: { zh: '牛肉干捞面', en: 'Beef stir-fried noodles', ms: 'Mee tumis daging' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 17.9 },
      ...
      { id: 'C6', code: 'C6', name: { zh: '鸡肉干捞面', en: 'Chicken stir-fried noodles', ms: 'Mee tumis ayam' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.9 },
    ],
  },
  {
    id: 'fried-rice',
  ...
  },
  {
    ...
    items: [
      { id: 'F1', code: 'F1', name: { zh: '土豆牛肉盖面', en: 'Hand-pulled noodles with potato and beef toppings', ms: 'Mee tarik dengan kentang dan daging' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.9 },
      { id: 'F2', code: 'F2', name: { zh: '香菇牛肉盖面', en: 'Hand-pulled noodles with mushroom and beef toppings', ms: 'Mee tarik dengan cendawan dan daging' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.9 },
      { id: 'F3', code: 'F3', name: { zh: '孜然牛肉盖面', en: 'Hand-pulled noodles with cumin beef toppings', ms: 'Mee tarik dengan daging jintan manis' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 18.9 },
      { id: 'F4', code: 'F4', name: { zh: '红烧牛肉盖面', en: 'Hand-pulled noodles with braised beef toppings', ms: 'Mee tarik dengan daging rebus' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 18.9 },
      { id: 'F5', code: 'F5', name: { zh: '红烧鸡盖面', en: 'Hand-pulled noodles with braised chicken toppings', ms: 'Mee tarik dengan ayam rebus' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 14.9 },
      { id: 'F6', code: 'F6', name: { zh: '番茄鸡蛋盖面', en: 'Hand-pulled noodles with tomatoes and eggs toppings', ms: 'Mee tarik dengan tomato dan telur' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 14.9 },
      { id: 'F7', code: 'F7', name: { zh: '新疆麻辣黄焖鸡盖面', en: 'Hand-pulled noodles with Xinjiang mala chicken toppings', ms: 'Mee tarik dengan ayam mala xinjiang' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 21.9 },
    ],
  },
  {
    id: 'side-dishes',
    ...
    items: [
      ...
      },
      {
        id: 'G5',
        code: 'G5',
        name: { zh: '椒麻鸡丝', en: 'Chinese Pepper Chicken salad', ms: 'Salad ayam cina lada' },
        desc: { zh: '', en: '', ms: '' },
        priceText: { zh: 'RM 7.00 / 12.00', en: 'RM 7.00 / 12.00', ms: 'RM 7.00 / 12.00' },
      },
    ],
  },
  {
    ...
    items: [
      { id: 'H1', code: 'H1', name: { zh: '新疆麻辣大盘鸡', en: 'Xinjiang mala chicken', ms: 'Xinjiang mala ayam' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 59.0 },
      { id: 'H2', code: 'H2', name: { zh: '黄焖鸡', en: 'Yellow braised chicken', ms: 'Ayam rebus kuning' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 38.0 },
      { id: 'H3', code: 'H3', name: { zh: '辣子鸡', en: 'Spicy chicken nuggets', ms: 'Nugget ayam pedas' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 28.0 },
      ...
      { id: 'H6', code: 'H6', name: { zh: '土豆红烧牛肉', en: 'Braised beef with potatoes', ms: 'Daging rebus dengan kentang' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 28.0 },
  ...
  },
  {
    ...
    items: [
      { id: 'J1', code: 'J1', name: { zh: '牛肉饼', en: 'Beef kebab', ms: 'Kebab daging' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 8.0 },
      { id: 'J2', code: 'J2', name: { zh: '葱油饼', en: 'Scallion pancake', ms: 'Pancake daun bawang' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 5.0 },
      { id: 'J3', code: 'J3', name: { zh: '手切牛肉片', en: 'Beef slice', ms: 'Hirisan daging' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.0 },
  ...
  },
  {
    ...
    items: [
      { id: 'K1', code: 'K1', name: { zh: '羊肉串（3串）', en: 'Lamb kebab', ms: 'Kebab kambing' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.0 },
      { id: 'K2', code: 'K2', name: { zh: '烧鸡翅（3串）', en: 'Chicken wing BBQ', ms: 'Kepak ayam' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 15.0 },
    ],
  },
  {
    id: 'drinks',
    ...
    items: [
      ...
      { id: 'L4', code: 'L4', name: { zh: '雀巢拉茶', en: 'Nestle Teh tarik', ms: 'Nestle Teh tarik' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 3.0 },
      ...
      { id: 'L8', code: 'L8', name: { zh: '雀巢橙饮', en: 'Nestle Orange drink', ms: 'Nestle Orange drink' }, desc: { zh: '', en: '', ms: '' }, priceMYR: 2.5 },
